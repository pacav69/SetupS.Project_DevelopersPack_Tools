...
#AutoIt3Wrapper_Outfile=Tools\SetupScp.exe
#AutoIt3Wrapper_Compression=4
#AutoIt3Wrapper_Res_Description=Alias for SetupS Control Panel
...
Run('ssControlPanel ' & ReconstructCmdLine($CLIparameters), '.', @SW_HIDE)
